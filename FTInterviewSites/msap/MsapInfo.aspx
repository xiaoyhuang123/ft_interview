<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MsapInfo.aspx.cs" Inherits="FTInterviewSites.msap.MsapInfo" %>
...
<body>
     <div class="container">
          ...
          <h3>基本信息</h3>
            ...
            <textarea name="MsName" id="MsName" class="span8 span-width" runat="server"></textarea>
          </div>
                </div>
            </div>-->
           ...
           <div class="control-group span12">
             ...
             <asp:Button ID="Save_Button" class="button button-primary" runat="server" 
                    Text="确定" onclick="Save_Button_Click"  />
          </div>
         ...
         <div class="row"  align="right">
            ...
            <div style=" float:right">
              <input type="button" id="btn_add_stuff"  class="button" value="添加考官"
