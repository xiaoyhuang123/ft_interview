<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Addmsap00.aspx.cs" Inherits="FTInterviewSites.msap.Addmsap00" %>
    ...
    <div class="container">
          ...
          <asp:GridView ID="ZpitmGridview" runat="server" AllowPaging="True" 
              ...
              <Columns>
                  ...
                  <asp:HyperLinkField DataNavigateUrlFormatString="AddMsap0.aspx?zpitmid={0}" Text="进入"
                    ItemStyle-Width="8%"
