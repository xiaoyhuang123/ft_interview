<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="FTInterviewSites.msg.index1" %>
        ...
        <div class="container">
         ...
         <div class="row"  align="center">
          ...
          <asp:GridView ID="MslbGridview" runat="server" AllowPaging="True" 
              ...
              <Columns>
                  <asp:TemplateField HeaderText="编号" ItemStyle-Width="5%">
                      <ItemTemplate>
                         <%# (Container.DataItemIndex+1).ToString()%>
                      </ItemTemplate>
                  </asp:TemplateField>
                   <asp:TemplateField HeaderText="面试名称" ItemStyle-Width="30%">
                      <ItemTemplate>
                          <asp:Label ID="TiName" runat="server" Text='<%# Bind("Title") %>'></asp:Label>
                      </ItemTemplate>
                  </asp:TemplateField>
                   <asp:TemplateField HeaderText="招聘部门" ItemStyle-Width="15%">
                      <ItemTemplate>
                          <asp:Label ID="ZpBm" runat="server" Text='<%# Bind("ZpbmName") %>'></asp:Label>
                      </ItemTemplate>
                  </asp:TemplateField>
                   <asp:TemplateField HeaderText="招聘岗位" ShowHeader="False" ItemStyle-Width="15%">
                        <ItemTemplate>
