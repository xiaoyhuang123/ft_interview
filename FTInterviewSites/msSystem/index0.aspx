<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index0.aspx.cs" Inherits="FTInterviewSites.msSystem.index0" %>
    ...
    <div class="container">
          ...
          <asp:GridView ID="ZpitmGridview" runat="server" AllowPaging="True" 
              ...
              <Columns>
                  ...
                  <asp:HyperLinkField DataNavigateUrlFormatString="index.aspx?zpitmid={0}" Text="进入"
                    ItemStyle-Width="8%"
