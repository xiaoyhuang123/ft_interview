<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddMsg.aspx.cs" Inherits="FTInterviewSites.msggl.AddMsg" %>
          ...
          <div class="row">
            <div class="control-group span12">
                <label class="control-label">
                    登陆密码：</label>
                <div class="controls">
                    <asp:TextBox ID="Pwsd" runat="server" TextMode="Password"></asp:TextBox>
                    <asp:Label ID="Label1" ForeColor="Gray" runat="server" Text="默认密码：123456"></asp:Label>
                </div>
            </div>
             <div class="control-group span12">  
                <div class="controls">
                    <asp:Button ID="Reset" runat="server" Text="重置" CssClass="button" onclick="Reset_Click" />
                </div>
            </div>
        </div>
        <hr />
