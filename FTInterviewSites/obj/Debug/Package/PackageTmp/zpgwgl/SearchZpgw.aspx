<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SearchZpgw.aspx.cs" Inherits="FTInterviewSites.zpgwgl.SearchZpgw" %>
...
<body>
    <div class="container">
             ...
             <div class="control-group span12">
              ...
              <div class="control-group span12">
                    <label class="control-label">
                        招聘岗位：</label>
                    <div class="controls">
                        <input id="gwName" name="gwName" type="text" runat="Server" class="control-text" />
                    </div>
                </div>   
        ...
        <div class="row"  align="right">
            ...
            <input type="button" id="btn_add_stuff" visible="false" class="button" value="添加招聘岗位" onclick="javascript:location.href='AddZpgw.aspx?zpitmid=<%=itmid_str %>'"/>
             <asp:Button ID="DeleteStuff" runat="Server" CssClass="button" Text="删除招聘岗位"  
                ToolTip="点此完成删除岗位" OnClientClick="return batchAudit(this)"
               ...
               <asp:TemplateField HeaderText="选择" HeaderStyle-HorizontalAlign="Center" HeaderStyle-VerticalAlign="Middle">
                  ...
                  <asp:TemplateField HeaderText="招聘部门">
                   ...
                   <asp:TemplateField HeaderText="发布时间">
                      <ItemTemplate>
                          <asp:Label ID="ZpFbtime" runat="server" Text='<%# Bind("FbTime") %>'></asp:Label>
                      </ItemTemplate>
                  </asp:TemplateField>
                 
                  <asp:HyperLinkField DataNavigateUrlFormatString="AddZpgw.aspx?zpfbid={0}" Text="详情"
