<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="zpitmindex.aspx.cs" Inherits="FTInterviewSites.zpgwgl.zpitmindex" %>
    ...
    <script type="text/javascript">
        ...
        function batchAudit(id) {
            ...
            if (AuditVal.length <= 0) {
                ...
                if (confirm("该操作会删除该招聘所有信息，您确认要删除吗？")) {
            ...
            <h3>招聘列表</h3>
             <div class="row"  align="right">
              ...
              <div class="row"  align="right">
                ...
                <input type="button" id="btn_add_ypz"  class="button" value="添加应聘" onclick="javascript:location.href='AddZpitem.aspx'"/>
                 <asp:Button ID="DeleteZpitm" runat="Server" CssClass="button" Text="删除招聘"  
                    ToolTip="点此完成删除招聘" OnClientClick="return batchAudit(this)" 
                      onclick="DeleteZpitm_Click" />  
              <br/><br/>
            </div>
          ...
          <asp:GridView ID="ZpitmGridview" runat="server" AllowPaging="True" 
              ...
              <Columns>
               <asp:TemplateField HeaderText="选择" HeaderStyle-HorizontalAlign="Center" HeaderStyle-VerticalAlign="Middle">
                  ...
                  <asp:HyperLinkField DataNavigateUrlFormatString="SearchZpgw.aspx?zpitmid={0}" Text="进入"
                    ItemStyle-Width="8%"
