<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SearchZhaopinItem.aspx.cs" Inherits="FTInterviewSites.SearchZhaopinItem" %>
            ...
            <h3>招聘列表</h3>
             <div class="row"  align="right">
              ...
              <div class="row"  align="right">
                ...
                <input type="button" id="btn_add_ypz"  class="button" value="添加应聘" onclick="javascript:location.href='AddYpz.aspx'"/>
          ...
          <asp:GridView ID="ZpitmGridview" runat="server" AllowPaging="True" 
              ...
              <Columns>
               <asp:TemplateField HeaderText="选择" HeaderStyle-HorizontalAlign="Center" HeaderStyle-VerticalAlign="Middle">
                  ...
                  <asp:HyperLinkField DataNavigateUrlFormatString="MsInfo.aspx?zpid={0}" Text="进入"
                    ItemStyle-Width="8%"
