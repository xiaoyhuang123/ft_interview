<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="YpzList.aspx.cs" Inherits="FTInterviewSites.msap.YpzList" %>
    ...
    <script type="text/javascript">
        ...
        function batchAudit(id) {
            ...
            if (AuditVal.length <= 0) {
                ...
                if (confirm("该操作会添加应聘者信息，您确认要执行吗？")) {
...
<body>
  <div class="container">
          <form id="J_Form" class="form-horizontal" action="YpzList.aspx" runat="Server">
            <div class="row">
            ...
            <div class="row"  align="right">
                <asp:HiddenField ID="hdfWPBH" runat="server" />
                 <asp:Button ID="DeleteYpz" runat="Server" CssClass="button" Text="添加"  
                    ToolTip="点此完成添加应聘者进入面试" OnClientClick="return batchAudit(this)"
          ...
          <asp:GridView ID="YpzGridview" runat="server" AllowPaging="False" 
              ...
              <Columns>
               <asp:TemplateField HeaderText="选择" HeaderStyle-HorizontalAlign="Center" HeaderStyle-VerticalAlign="Middle">
                  ...
                  <asp:HyperLinkField DataNavigateUrlFormatString="YpzInfo.aspx?ypz_id={0}" Text="详情"
