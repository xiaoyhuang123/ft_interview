<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Zpitmindex.aspx.cs" Inherits="FTInterviewSites.ypzgl.Zpitmindex" %>
      ...
      <div class="container">
          ...
          <asp:GridView ID="ZpitmGridview" runat="server" AllowPaging="True" 
              ...
              <Columns>
                  ...
                  <asp:HyperLinkField DataNavigateUrlFormatString="SearchYpz.aspx?zpitmid={0}" Text="进入"
                    ItemStyle-Width="8%"
