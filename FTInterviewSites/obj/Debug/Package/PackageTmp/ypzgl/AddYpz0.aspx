<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddYpz0.aspx.cs" Inherits="FTInterviewSites.ypzgl.AddYpz0" %>
     ...
     <div class="container">
          ...
          <asp:GridView ID="ZpitmGridview" runat="server" AllowPaging="True" 
              ...
              <Columns>
                  ...
                  <asp:HyperLinkField DataNavigateUrlFormatString="AddYpz.aspx?zpitmid={0}" Text="进入"
                    ItemStyle-Width="8%"
