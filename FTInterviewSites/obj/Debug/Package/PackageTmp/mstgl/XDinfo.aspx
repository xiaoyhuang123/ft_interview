<%@ Page Language="C#"  AutoEventWireup="true" CodeBehind="XDinfo.aspx.cs" Inherits="FTInterviewSites.mstgl.XDinfo" %>
      ...
      <div class="row">
             <div class="control-group span12">
                    <label class="control-label">
                        分值:</label>
                    <div class="controls">
                          <input id="ScoreValue" name="ScoreValue" type="text" runat="Server" class="control-text" />
                    </div>
                </div>
            </div>
      <h3>项点内容</h3>
