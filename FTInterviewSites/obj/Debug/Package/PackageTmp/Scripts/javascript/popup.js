...
Popup.prototype = {
    ...
    build: function () {
        ...
        var path = "../Scripts/javascript/dialogclose.gif";
    ...
    showSome: function () {
        ...
        //top.topManager.reloadPage('code7');   
        space("end")
...
function ShowHtmlString( strTitle, w, h, strHtml )
{
    var pop = new Popup( {
        contentType: 2,
        isReloadOnClose: false,
...
function ClosePopWithRefresh( isfresh )
{
    if ( isfresh )
    {
