<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MsjgIndex.aspx.cs" Inherits="FTInterviewSites.msjggl.MsjgIndex" %>
   ...
   <div class="container">
          ...
          <asp:GridView ID="ZpitmGridview" runat="server" AllowPaging="True" 
              ...
              <Columns>
                  ...
                  <asp:HyperLinkField DataNavigateUrlFormatString="SearchMsjg.aspx?zpitmid={0}" Text="进入"
                    ItemStyle-Width="8%"
