<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="historyindex.aspx.cs" Inherits="FTInterviewSites.systemmanage.historyindex" %>
      ...
      <div class="container">
          ...
          <asp:GridView ID="ZpitmGridview" runat="server" AllowPaging="True" 
              ...
              <Columns>
                  ...
                  <asp:HyperLinkField DataNavigateUrlFormatString="Historylist.aspx?zpitmid={0}" Text="进入"
                    ItemStyle-Width="8%"
