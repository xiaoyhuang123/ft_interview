<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddBm.aspx.cs" Inherits="FTInterviewSites.bmgl.AddBm" %>
      ...
      <h3>基本信息</h3>
       ...
       <div class="row">
        <div class="control-group span12">
          ...
          <div class="controls">
            <input name="Dname" id="Dname" type="text" class="control-text" data-rules="{required:true}"  runat="server">
          </div>
        </div>
       </div> 
